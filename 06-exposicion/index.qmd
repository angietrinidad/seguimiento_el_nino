...
- La cobertura de salud y educación de **OpenStreetMap no es exhaustiva ni
  oficial**: subestima establecimientos, sobre todo en el interior. Pendiente
  contrastar con **MSPBS** (salud) y **MEC** (educación). OSM tampoco trae
  **capacidad/matrícula** (número de personas por establecimiento).
