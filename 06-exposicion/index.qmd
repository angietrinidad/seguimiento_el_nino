...
- Servicios de salud: **healthsites.io / OpenStreetMap**, ODbL [@healthsites]
  (pendiente cruce con MSPBS; OSM no trae camas).
...
- **Salud** sigue en **OpenStreetMap** (no exhaustivo ni oficial, sin camas);
  pendiente cruzar con el registro georreferenciado del **MSPBS**.
