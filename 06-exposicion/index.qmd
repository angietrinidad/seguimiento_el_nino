...
::: {.callout-tip}
## Descarga: escuelas en riesgo (Excel)
Las **24 escuelas** dentro de la zona de riesgo, con ubicación, **matrícula** (MEC,
último año disponible), **tipo de gestión** y **el nivel del río al que se inundan**,
están disponibles en una planilla:
**[⬇ Descargar escuelas_riesgo.xlsx](../datos/exposicion/escuelas_riesgo.xlsx)**.
Cada escuela se cuenta en una sola zona (sin doble conteo en el solapamiento
Asunción–Villa Hayes).
:::
...
[Asunción metropolitana](../04-asuncion-metropolitana/index.qmd#inundaciones-pluviales-urbanas).
...
- **Susceptibilidad pluvial:** modelo topográfico propio sobre el Copernicus DEM
  ...
  [@copernicus_dem]. Evidencia de eventos y teleconexión ENOS-lluvia citada en
  [Asunción metropolitana](../04-asuncion-metropolitana/index.qmd).
