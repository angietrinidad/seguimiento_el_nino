...
tooltip); los **1.056 servicios de salud** (MSPBS) se muestran agrupados. Solo se
dibujan individualmente los **expuestos** en la zona de riesgo. Nota: varias USF y
escuelas comparten predio (misma coordenada) y se cuentan como servicios distintos.
Acercá el mapa a Asunción para ver la zona de riesgo y los establecimientos
expuestos.*
